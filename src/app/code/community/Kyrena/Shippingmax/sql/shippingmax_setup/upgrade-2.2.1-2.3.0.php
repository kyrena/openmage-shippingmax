...
try {
	$this->run('DELETE FROM '.$this->getTable('shippingmax_coords').' WHERE country_id = "FR" AND postcode IN (
		75000, 75001, 75002, 75003, 75004, 75005, 75006, 75007, 75008, 75009, 75010, 75011, 75012, 75013, 75014, 75015, 75016, 75116, 75017, 75018, 75019, 75020, 13000, 13001, 13002, 13003, 13004, 13005, 13006, 13007, 13008, 13009, 13010, 13011, 13012, 13013, 13014, 13015, 13016, 69000, 69001, 69002, 69003, 69004, 69005, 69006, 69007, 69008, 69009
	);');
